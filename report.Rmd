...
Figure \@ref(fig:var-additional) shows their distribution, and Figure \@ref(fig:diagnostic-additional)+\@ref(fig:diagnostic-additional-cont) shows that regression assumptions are all still approximately satisfied for the updated Model \@ref(eq:additional), similar to what we saw earlier in Figure \@ref(fig:diagnostic-transformed).
