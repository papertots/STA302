...
The choices in these predictors are inspired by the R summary output of the model (which we will omit here),
...
even with linear regression assumptions only approximately satisfied.
